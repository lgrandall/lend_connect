...
RSpec.describe "add_investment_months/index", type: :view do
  before(:each) do
    assign(:add_investment_months, [
      AddInvestmentMonth.create!(
        :user => nil,
        :user_scenario => nil,
  ...
  it "renders a list of add_investment_months" do
    render
