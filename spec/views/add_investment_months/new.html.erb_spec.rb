...
RSpec.describe "add_investment_months/new", type: :view do
  before(:each) do
    assign(:add_investment_month, AddInvestmentMonth.new(
      :user => nil,
      :user_scenario => nil,
  ...
  it "renders new add_investment_month form" do
    render

    assert_select "form[action=?][method=?]", add_investment_months_path, "post" do
